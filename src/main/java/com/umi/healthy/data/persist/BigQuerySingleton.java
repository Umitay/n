...
public enum BigQuerySingleton
{
	...
	private Bigquery bigquery = new Bigquery.Builder(TRANSPORT, JSON_FACTORY, getRequestInitializer()).setApplicationName(EnvironmentConfig.getInstance().getApplicationID()).build();
